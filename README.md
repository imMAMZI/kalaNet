...
## 10) Known Naming Inconsistency

Some UI text references **"PinkMart"** in the in-app guide page. This appears to be legacy naming and does not affect runtime behavior.

---

## 11) License / Academic Use

This repository appears to be an academic course project submission. Add your preferred license and attribution policy if you plan to distribute it publicly.
